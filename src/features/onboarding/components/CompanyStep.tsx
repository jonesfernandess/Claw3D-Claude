        ...
        {[
          {
            ...
            description: "Use your connected Claude runtime to sharpen the company prompt.",
          },
          {
            icon: Users,
          ...
          },
          {
            ...
            description: "Write agent files and create the team directly in Claw3D.",
          },
      ...
      <div className="pt-4">
        {canOpenBuilder ? (
          ...
          <div className="rounded-md border border-amber-500/20 bg-amber-500/10 px-4 py-3 text-xs text-amber-100/80">
            Connect to Claude and keep at least one planning agent available to generate the
            company with AI.
          </div>
        )}
      </div>
